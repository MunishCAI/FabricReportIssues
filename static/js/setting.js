...
$(document).ready(function () {
    ...
    var index = 0;
    var list = ["image1.jpg", "image2.jpg", "image3.jpg", "image4.jpg", "image5.jpg", "image6.jpg", "image7.jpg", "image8.jpg", "image9.jpg", "image10.jpg", "image11.jpg", "image12.jpg", "image13.jpg", "image14.jpg", "image15.jpg", "image16.jpg", "image17.jpg", "image18.jpg", "image19.jpg", "image20.jpg", "image21.jpg", "image22.jpg", "image23.jpg", "image24.jpg", "image25.jpg", "image26.jpg", "image27.jpg", "image28.jpg", "image29.jpg", "image30.jpg", "image31.jpg", "image31.jpg", "image32.jpg", "image33.jpg", "image34.jpg", "image35.jpg"];
    ...
    var alarmLogButton = document.getElementById('alarmLogRport_setting');
    ...
    function colorchange_navBar(cus_nav) {
        ...
        logoName.style.backgroundColor = "rgb(212, 219, 219)";
        uptimeButton.style.color = "blue";
        uptimeButton.style.backgroundColor = "rgb(212, 219, 219)";
        alarmLogButton.style.color = "blue";
        alarmLogButton.style.backgroundColor = "rgb(212, 219, 219)";
...
`;
    ...
    logoName.addEventListener('click', function () {
        ...
        colorchange_navBar(logoName);
        clearInterval(intervalId);
        var logoName = `
        <form id="logoName_form" class="form-container"  action="/updatelogoName" method="post">          
        <div>
          <table>
            <tr>
              <td><h2 style="padding-top: -10px;"for="new_logoName">Select Logo:&nbsp;&nbsp; </h2></td>
              <td><label ><input id="new_logoName" name="logoName" type="text"/><div ></div></label> </td>
            </tr>
          </table>       
          <button style="width:300px;" type="submit" id="new_setting_logoName" class="btn btn-primary" action="/tt">Submit</button>
        </div> 
      </form>  
      `
        $("#newstting_data").html(logoName);

        $("#logoName_form").submit(function (e) {
            e.preventDefault();
        ...
        var logoNameSubmit = document.getElementById('new_setting_logoName');
        logoNameSubmit.addEventListener('click', function () {
            swal("Updated!", "Your logo name has been updated!", "success")
        });
    });
    // version
    ...
    // AlarmLog Button
    alarmLogButton.addEventListener('click', function () {
        colorchange_navBar(alarmLogButton);
        clearInterval(intervalId);
        var bypass_html = `
        <div class="con2">
          <label for="datepicker">Select a date:&nbsp;&nbsp;</label>
          <input type="date" id="datepicker" name="datepicker" required><br><br>
          <button type="button" id="generateReportButton" class="btn btn-primary">Generate Alarmlog Report</button>  
        </div>
      `
        $("#newstting_data").html(bypass_html);


        // window.location.replace('alarm_log_viewer_api'); 
        ...
        generateReportButton.addEventListener('click', function () {
            ...
            if (rdate === "") {
                ...
                $.ajax({
                    url: '/alarmlog/' + rdate, // Replace with your API endpoint
    ...
    function createTable1(data) {
        ...
        const headings = ['Deftect Id', 'Defect Name', 'Alarm Status', 'Instance Count', 'Sensitivity', 'Defect Length'];
        ...
        data.forEach(item => {
            ...
            for (const key in item) {
                ...
                if (key === 'score') {
                    ...
                    input.step = 1;
                    input.value = item[key] * 100; // Set the initial value from the data
                    input.id = 'defect_lengthInput' + item['adefecTypeId'];
                    input.name = 'defect_lengthInput' + item['adefecTypeId'];
                    cell.appendChild(input);
                } else {
    ...
    shiftButton.addEventListener('click', function () {
      ...
      `
        ...
        function verifyData() {
            ...
            const totalDurationMinutes = timeRanges.reduce((total, {
                start,
                end
            }) => {
